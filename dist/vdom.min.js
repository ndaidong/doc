(function(g){if("undefined"!==typeof module&&module.exports)module.exports=g();else{var h=window||{};h.define&&h.define.amd?h.define([],g):h.exports?h.exports=g():(g=g(),h.DOM=g.DOM,h.vDOM=g.vDOM)}})(function(){var g={},h={},m=function(a){return"string"===typeof a},n=function(a,b){if(!a||!b)return!1;var c=!0;void 0===a[b]&&(c=b in a);return c},q=function(a,b){if(!m(a))return"";var c=a?a.replace(/^[\s\xa0]+|[\s\xa0]+$/g,""):a||"";return c&&b?c.replace(/\r?\n|\r/g," ").replace(/\s\s+|\r/g," "):c},k,
w,p;k=function(a){var b=(m(a)?document.getElementById(a):a)||null;if(b&&b instanceof HTMLElement){var c=b.classList;b.hasClass=function(b){return(b=q(b,!0))?c.contains(b):!1};b.addClass=function(a){a=q(a,!0);if(!a)return!1;var e=a.split(" ");1<e.length?e.forEach(function(b){c.add(b)}):c.add(a);return b};b.removeClass=function(a){a=q(a,!0);if(!a)return!1;var e=a.split(" ");1<e.length?e.forEach(function(a){c.remove(a)}):c.remove(a);return b};b.toggleClass=function(a){a=q(a,!0);if(!a)return!1;var e=
