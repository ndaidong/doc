(function(g,h){if("object"===typeof exports&&"undefined"!==typeof module)module.exports=h();else if("function"===typeof define&&define.amd)define(h);else{var l=h();g.DOM=l.DOM;g.vDOM=l.vDOM}})(this,function(){var g={},h={},l=function(a){return"string"===typeof a},n=function(a,b){if(!a||!b)return!1;var c=!0;void 0===a[b]&&(c=b in a);return c},q=function(a,b){if(!l(a))return"";var c=a?a.replace(/^[\s\xa0]+|[\s\xa0]+$/g,""):a||"";return c&&b?c.replace(/\r?\n|\r/g," ").replace(/\s\s+|\r/g," "):c},k,w,
p;k=function(a){var b=(l(a)?document.getElementById(a):a)||null;if(b&&b instanceof HTMLElement){var c=b.classList;b.hasClass=function(b){return(b=q(b,!0))?c.contains(b):!1};b.addClass=function(a){a=q(a,!0);if(!a)return!1;var e=a.split(" ");1<e.length?e.forEach(function(b){c.add(b)}):c.add(a);return b};b.removeClass=function(a){a=q(a,!0);if(!a)return!1;var e=a.split(" ");1<e.length?e.forEach(function(a){c.remove(a)}):c.remove(a);return b};b.toggleClass=function(a){a=q(a,!0);if(!a)return!1;var e=a.split(" ");
1<e.length?e.forEach(function(a){c.toggle(a)}):c.toggle(a);return b};b.empty=function(){b.innerHTML="";return b};b.html=function(a){if(void 0===a)return b.innerHTML;b.innerHTML=a;return b};b.destroy=function(){b.parentNode&&b.parentNode.removeChild(b)}}return b};w=function(a,b){var c=b?k(b):document.body,d=a instanceof HTMLElement?a:document.createElement(a);c.appendChild(d);return k(d)};p=function(a){return k(document.createElement(a))};g.ready=function(a){"loading"!==document.readyState?setTimeout(a,
